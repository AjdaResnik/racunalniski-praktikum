...
S $k_n$ označimo število kršitev omejitve $n$, z $u_n$ pa njeno utež. Z naslednjo formulo izračunamo
kakovost urnika:
...
Lok\subsubsection{Lokalno vzpenjanje}
...
I\subsubsection{Iskanje s tabuji}
